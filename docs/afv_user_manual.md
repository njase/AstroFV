...
We define the upwind flux across the FV cell surfaces as:
...
<a href="https://www.codecogs.com/eqnedit.php?latex=Mx_{j}^{up}&space;=&space;\begin{cases}&space;Mx_{j}&space;\quad&space;\text{&space;if&space;}&space;V_{j}^x&space;\leq&space;0&space;\\&space;Mx_{j-1}&space;\quad&space;\text{&space;if&space;}&space;V_{j}^x&space;>&space;0&space;\end{cases}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?Mx_{j}^{up}&space;=&space;\begin{cases}&space;Mx_{j}&space;\quad&space;\text{&space;if&space;}&space;V_{j}^x&space;\leq&space;0&space;\\&space;Mx_{j-1}&space;\quad&space;\text{&space;if&space;}&space;V_{j}^x&space;>&space;0&space;\end{cases}" title="Mx_{j}^{up} = \begin{cases} Mx_{j} \quad \text{ if } V_{j}^x \leq 0 \\ Mx_{j-1} \quad \text{ if } V_{j}^x > 0 \end{cases}" /></a>
...
###### Discretized equations using Implicit Euler and Crank-Nicholson

The paramater <a href="https://www.codecogs.com/eqnedit.php?latex=\alpha" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\alpha" title="\alpha" /></a> controls the implicit scheme. Value 1.0 implies Implicit Euler and value 0.5 implies Crank-Nicholson

The 3 set of equations can be written as:

<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{D_{j}^{n&plus;1}&space;-&space;D_{j}^{n}}{\Delta&space;t}&space;&plus;&space;\alpha&space;\left(&space;\frac{D_{j&plus;1}^{up,n&plus;1}V_{j&plus;1}^{x,n}&space;-&space;D_{j}^{up,n&plus;1}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;(1-\alpha)&space;\left(&space;\frac{D_{j&plus;1}^{up,n}V_{j&plus;1}^{x,n}&space;-&space;D_{j}^{up,n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;0" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{D_{j}^{n&plus;1}&space;-&space;D_{j}^{n}}{\Delta&space;t}&space;&plus;&space;\alpha&space;\left(&space;\frac{D_{j&plus;1}^{up,n&plus;1}V_{j&plus;1}^{x,n}&space;-&space;D_{j}^{up,n&plus;1}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;(1-\alpha)&space;\left(&space;\frac{D_{j&plus;1}^{up,n}V_{j&plus;1}^{x,n}&space;-&space;D_{j}^{up,n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;0" title="\frac{D_{j}^{n+1} - D_{j}^{n}}{\Delta t} + \alpha \left( \frac{D_{j+1}^{up,n+1}V_{j+1}^{x,n} - D_{j}^{up,n+1}V_{j}^{x,n}}{\Delta x} \right) + (1-\alpha) \left( \frac{D_{j+1}^{up,n}V_{j+1}^{x,n} - D_{j}^{up,n}V_{j}^{x,n}}{\Delta x} \right) = 0" /></a>

<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{M_{j}^{n&plus;1}&space;-&space;M_{j}^{n}}{\Delta&space;t}&space;&plus;&space;\alpha&space;\left(&space;\frac{M_{j}^{up,n&plus;1}\langle&space;V_{j}^{x,n}&space;\rangle&space;-&space;M_{j-1}^{up,n&plus;1}&space;\langle&space;V_{j-1}^{x,n}&space;\rangle}{\Delta&space;x}&space;\right)&space;&plus;&space;(1-\alpha)&space;\left(&space;\frac{M_{j}^{up,n}\langle&space;V_{j}^{x,n}&space;\rangle&space;-&space;M_{j-1}^{up,n}&space;\langle&space;V_{j-1}^{x,n}&space;\rangle}{\Delta&space;x}&space;\right)&space;=&space;\frac{p_{j}-p_{j-1}}{\Delta&space;x}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{M_{j}^{n&plus;1}&space;-&space;M_{j}^{n}}{\Delta&space;t}&space;&plus;&space;\alpha&space;\left(&space;\frac{M_{j}^{up,n&plus;1}\langle&space;V_{j}^{x,n}&space;\rangle&space;-&space;M_{j-1}^{up,n&plus;1}&space;\langle&space;V_{j-1}^{x,n}&space;\rangle}{\Delta&space;x}&space;\right)&space;&plus;&space;(1-\alpha)&space;\left(&space;\frac{M_{j}^{up,n}\langle&space;V_{j}^{x,n}&space;\rangle&space;-&space;M_{j-1}^{up,n}&space;\langle&space;V_{j-1}^{x,n}&space;\rangle}{\Delta&space;x}&space;\right)&space;=&space;\frac{p_{j}-p_{j-1}}{\Delta&space;x}" title="\frac{M_{j}^{n+1} - M_{j}^{n}}{\Delta t} + \alpha \left( \frac{M_{j}^{up,n+1}\langle V_{j}^{x,n} \rangle - M_{j-1}^{up,n+1} \langle V_{j-1}^{x,n} \rangle}{\Delta x} \right) + (1-\alpha) \left( \frac{M_{j}^{up,n}\langle V_{j}^{x,n} \rangle - M_{j-1}^{up,n} \langle V_{j-1}^{x,n} \rangle}{\Delta x} \right) = \frac{p_{j}-p_{j-1}}{\Delta x}" /></a>
   
<a href="https://www.codecogs.com/eqnedit.php?latex=\frac{E_{j}^{n&plus;1}&space;-&space;E_{j}^{n}}{\Delta&space;t}&space;&plus;&space;\alpha&space;\left(&space;\frac{E_{j&plus;1}^{up,n&plus;1}V_{j&plus;1}^{x,n}&space;-&space;E_{j}^{up,n&plus;1}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;(1-\alpha)&space;\left(&space;\frac{E_{j&plus;1}^{up,n}V_{j&plus;1}^{x,n}&space;-&space;E_{j}^{up,n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;(\gamma&space;-&space;1)&space;\frac{E_{j}^{n&plus;1}}{u^{n&plus;1}}&space;\left(&space;\frac{u^{n&plus;1}&space;-&space;u^{n}}{\Delta&space;t}&space;&plus;&space;\frac{V_{j&plus;1}^n-V_{j}^n}{\Delta&space;x}&space;\right&space;)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{E_{j}^{n&plus;1}&space;-&space;E_{j}^{n}}{\Delta&space;t}&space;&plus;&space;\alpha&space;\left(&space;\frac{E_{j&plus;1}^{up,n&plus;1}V_{j&plus;1}^{x,n}&space;-&space;E_{j}^{up,n&plus;1}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;(1-\alpha)&space;\left(&space;\frac{E_{j&plus;1}^{up,n}V_{j&plus;1}^{x,n}&space;-&space;E_{j}^{up,n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;(\gamma&space;-&space;1)&space;\frac{E_{j}^{n&plus;1}}{u^{n&plus;1}}&space;\left(&space;\frac{u^{n&plus;1}&space;-&space;u^{n}}{\Delta&space;t}&space;&plus;&space;\frac{V_{j&plus;1}^n-V_{j}^n}{\Delta&space;x}&space;\right&space;)" title="\frac{E_{j}^{n+1} - E_{j}^{n}}{\Delta t} + \alpha \left( \frac{E_{j+1}^{up,n+1}V_{j+1}^{x,n} - E_{j}^{up,n+1}V_{j}^{x,n}}{\Delta x} \right) + (1-\alpha) \left( \frac{E_{j+1}^{up,n}V_{j+1}^{x,n} - E_{j}^{up,n}V_{j}^{x,n}}{\Delta x} \right) = (\gamma - 1) \frac{E_{j}^{n+1}}{u^{n+1}} \left( \frac{u^{n+1} - u^{n}}{\Delta t} + \frac{V_{j+1}^n-V_{j}^n}{\Delta x} \right )" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=D_{j-1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;D_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;&plus;&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;D_{j&plus;1}^{n&plus;1}&space;(0)&space;=&space;\frac{D_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{D_{j}^{n}V_{j&plus;1}^{x,n}&space;-&space;D_{j-1}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?D_{j-1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;D_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;&plus;&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;D_{j&plus;1}^{n&plus;1}&space;(0)&space;=&space;\frac{D_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{D_{j}^{n}V_{j&plus;1}^{x,n}&space;-&space;D_{j-1}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" title="D_{j-1}^{n+1} \left( \frac{-\alpha V_{j}^{x,n}}{\Delta x} \right) + D_{j}^{n+1} \left( \frac{1}{\Delta t} + \frac{\alpha V_{j+1}^{x,n}}{\Delta x} \right) + D_{j+1}^{n+1} (0) = \frac{D_{j}^{n}}{\Delta t} - (1-\alpha) \left(\frac{D_{j}^{n}V_{j+1}^{x,n} - D_{j-1}^{n}V_{j}^{x,n}}{\Delta x} \right)" /></a>
   
   
<a href="https://www.codecogs.com/eqnedit.php?latex=M_{j-1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;M_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;&plus;&space;\frac{\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;M_{j&plus;1}^{n&plus;1}&space;(0)&space;=&space;\frac{M_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{M_{j}^{n}V_{j}^{x,n}&space;-&space;M_{j-1}^{n}V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;-&space;\frac{p_{j}-p_{j-1}}{\Delta&space;x}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?M_{j-1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;M_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;&plus;&space;\frac{\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;M_{j&plus;1}^{n&plus;1}&space;(0)&space;=&space;\frac{M_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{M_{j}^{n}V_{j}^{x,n}&space;-&space;M_{j-1}^{n}V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;-&space;\frac{p_{j}-p_{j-1}}{\Delta&space;x}" title="M_{j-1}^{n+1} \left( \frac{-\alpha V_{j-1}^{x,n}}{\Delta x} \right) + M_{j}^{n+1} \left( \frac{1}{\Delta t} + \frac{\alpha V_{j}^{x,n}}{\Delta x} \right) + M_{j+1}^{n+1} (0) = \frac{M_{j}^{n}}{\Delta t} - (1-\alpha) \left(\frac{M_{j}^{n}V_{j}^{x,n} - M_{j-1}^{n}V_{j-1}^{x,n}}{\Delta x} \right) - \frac{p_{j}-p_{j-1}}{\Delta x}" /></a>
   
   
<a href="https://www.codecogs.com/eqnedit.php?latex=E_{j-1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;E_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;&plus;&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;-&space;\frac{\gamma&space;-&space;1}{u^{n&plus;1}}&space;\left(&space;\frac{\partial&space;u}{\partial&space;t}&space;&plus;&space;\frac{V_{j&plus;1}^{x,n}-V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;\right)&space;&plus;&space;E_{j&plus;1}^{n&plus;1}&space;(0)&space;=&space;\frac{E_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{E_{j}^{n}V_{j&plus;1}^{x,n}&space;-&space;E_{j-1}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?E_{j-1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;E_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;&plus;&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;-&space;\frac{\gamma&space;-&space;1}{u^{n&plus;1}}&space;\left(&space;\frac{\partial&space;u}{\partial&space;t}&space;&plus;&space;\frac{V_{j&plus;1}^{x,n}-V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;\right)&space;&plus;&space;E_{j&plus;1}^{n&plus;1}&space;(0)&space;=&space;\frac{E_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{E_{j}^{n}V_{j&plus;1}^{x,n}&space;-&space;E_{j-1}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" title="E_{j-1}^{n+1} \left( \frac{-\alpha V_{j}^{x,n}}{\Delta x} \right) + E_{j}^{n+1} \left( \frac{1}{\Delta t} + \frac{\alpha V_{j+1}^{x,n}}{\Delta x} - \frac{\gamma - 1}{u^{n+1}} \left( \frac{\partial u}{\partial t} + \frac{V_{j+1}^{x,n}-V_{j}^{x,n}}{\Delta x} \right) \right) + E_{j+1}^{n+1} (0) = \frac{E_{j}^{n}}{\Delta t} - (1-\alpha) \left(\frac{E_{j}^{n}V_{j+1}^{x,n} - E_{j-1}^{n}V_{j}^{x,n}}{\Delta x} \right)" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=D_{j-1}^{n&plus;1}(0)&space;&plus;&space;D_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;-&space;\frac{\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;D_{j&plus;1}^{n&plus;1}&space;\left(&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;\frac{D_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{D_{j&plus;1}^{n}V_{j&plus;1}^{x,n}&space;-&space;D_{j}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?D_{j-1}^{n&plus;1}(0)&space;&plus;&space;D_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;-&space;\frac{\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;D_{j&plus;1}^{n&plus;1}&space;\left(&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;\frac{D_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{D_{j&plus;1}^{n}V_{j&plus;1}^{x,n}&space;-&space;D_{j}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" title="D_{j-1}^{n+1}(0) + D_{j}^{n+1} \left( \frac{1}{\Delta t} - \frac{\alpha V_{j}^{x,n}}{\Delta x} \right) + D_{j+1}^{n+1} \left( \frac{\alpha V_{j+1}^{x,n}}{\Delta x} \right) = \frac{D_{j}^{n}}{\Delta t} - (1-\alpha) \left(\frac{D_{j+1}^{n}V_{j+1}^{x,n} - D_{j}^{n}V_{j}^{x,n}}{\Delta x} \right)" /></a>
   
  
<a href="https://www.codecogs.com/eqnedit.php?latex=M_{j-1}^{n&plus;1}&space;(0)&space;&plus;&space;M_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;-&space;\frac{\alpha&space;V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;M_{j&plus;1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;\frac{M_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{M_{j&plus;1}^{n}V_{j}^{x,n}&space;-&space;M_{j}^{n}V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;-&space;\frac{p_{j}-p_{j-1}}{\Delta&space;x}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?M_{j-1}^{n&plus;1}&space;(0)&space;&plus;&space;M_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;-&space;\frac{\alpha&space;V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;&plus;&space;M_{j&plus;1}^{n&plus;1}&space;\left(&space;\frac{-\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;\frac{M_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{M_{j&plus;1}^{n}V_{j}^{x,n}&space;-&space;M_{j}^{n}V_{j-1}^{x,n}}{\Delta&space;x}&space;\right)&space;-&space;\frac{p_{j}-p_{j-1}}{\Delta&space;x}" title="M_{j-1}^{n+1} (0) + M_{j}^{n+1} \left( \frac{1}{\Delta t} - \frac{\alpha V_{j-1}^{x,n}}{\Delta x} \right) + M_{j+1}^{n+1} \left( \frac{-\alpha V_{j}^{x,n}}{\Delta x} \right) = \frac{M_{j}^{n}}{\Delta t} - (1-\alpha) \left(\frac{M_{j+1}^{n}V_{j}^{x,n} - M_{j}^{n}V_{j-1}^{x,n}}{\Delta x} \right) - \frac{p_{j}-p_{j-1}}{\Delta x}" /></a>
  
<a href="https://www.codecogs.com/eqnedit.php?latex=E_{j-1}^{n&plus;1}&space;(0)&space;&plus;&space;E_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;-&space;\frac{\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;-&space;\frac{\gamma&space;-&space;1}{u^{n&plus;1}}&space;\left(&space;\frac{\partial&space;u}{\partial&space;t}&space;&plus;&space;\frac{V_{j&plus;1}^{x,n}-V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;\right)&space;&plus;&space;E_{j&plus;1}^{n&plus;1}&space;\left(&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;\frac{E_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{E_{j&plus;1}^{n}V_{j&plus;1}^{x,n}&space;-&space;E_{j}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?E_{j-1}^{n&plus;1}&space;(0)&space;&plus;&space;E_{j}^{n&plus;1}&space;\left(&space;\frac{1}{\Delta&space;t}&space;-&space;\frac{\alpha&space;V_{j}^{x,n}}{\Delta&space;x}&space;-&space;\frac{\gamma&space;-&space;1}{u^{n&plus;1}}&space;\left(&space;\frac{\partial&space;u}{\partial&space;t}&space;&plus;&space;\frac{V_{j&plus;1}^{x,n}-V_{j}^{x,n}}{\Delta&space;x}&space;\right)&space;\right)&space;&plus;&space;E_{j&plus;1}^{n&plus;1}&space;\left(&space;\frac{\alpha&space;V_{j&plus;1}^{x,n}}{\Delta&space;x}&space;\right)&space;=&space;\frac{E_{j}^{n}}{\Delta&space;t}&space;-&space;(1-\alpha)&space;\left(\frac{E_{j&plus;1}^{n}V_{j&plus;1}^{x,n}&space;-&space;E_{j}^{n}V_{j}^{x,n}}{\Delta&space;x}&space;\right)" title="E_{j-1}^{n+1} (0) + E_{j}^{n+1} \left( \frac{1}{\Delta t} - \frac{\alpha V_{j}^{x,n}}{\Delta x} - \frac{\gamma - 1}{u^{n+1}} \left( \frac{\partial u}{\partial t} + \frac{V_{j+1}^{x,n}-V_{j}^{x,n}}{\Delta x} \right) \right) + E_{j+1}^{n+1} \left( \frac{\alpha V_{j+1}^{x,n}}{\Delta x} \right) = \frac{E_{j}^{n}}{\Delta t} - (1-\alpha) \left(\frac{E_{j+1}^{n}V_{j+1}^{x,n} - E_{j}^{n}V_{j}^{x,n}}{\Delta x} \right)" /></a>
...
**Key Data structures**
 ...
 ```python
  ...
  ```
   These are used to define parameters for Explicit Euler time integration and Implicit/Crank-nicholson time integration. 
 
   gamma = 0 defines isothermal gas
 
   Time limits are default [0,1] and spatial limits are default [0,1].
   
   Temporal grid size is automatically chosen by dividing Time limit by ncells.
   
   Spatial grid size is automatically derived from temporal grid size by using CFL parameter.
...
**Usage examples**
 ...
 ###### Solve RSTP using Crank-Niholson
